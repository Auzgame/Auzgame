...
var ResZipFileLoader = {
    ...
    request: function request(url, method, responseType, currentAttempt) {
        ...
        if (typeof method === "responseType")
            throw "No responseType specified";
        if (typeof currentAttempt === "undefined")
            currentAttempt = 0;
        var obj = {
            send: function send() {
...
var JSEvents = {
    ...
    deferCall: function deferCall(targetFunction, precedence, argsList) {
        ...
        var _iterator = _createForOfIteratorHelper(JSEvents.deferredCalls), _step;
        try {
    ...
    runDeferredCalls: function runDeferredCalls() {
        ...
        JSEvents.deferredCalls = [];
        var _iterator2 = _createForOfIteratorHelper(deferredCalls), _step2;
        try {
...
var setMainLoop = function setMainLoop(browserIterationFunc, fps, simulateInfiniteLoop, arg, noSetTiming) {
    ...
    Browser.mainLoop.runner = function Browser_mainLoop_runner() {
        ...
        if (!checkIsRunning())
            return;
        if ((typeof SDL === "undefined" ? "undefined" : _typeof(SDL)) == "object")
            (_SDL$audio = SDL.audio) === null || _SDL$audio === void 0 || (_SDL$audio$queueNewAu = _SDL$audio.queueNewAudioData) === null || _SDL$audio$queueNewAu === void 0 || _SDL$audio$queueNewAu.call(_SDL$audio);
        Browser.mainLoop.scheduler()
    }
    ;
    if (!noSetTiming) {
