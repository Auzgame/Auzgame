  ...
  [1054],
  {
    1054: (e, t, s) => {
      ...
      var C = s(82259),
        ...
        m = s(86480);
      const p = () => {
          const { spacing: e } = (0, d.Z)(),
            { showInviteButton: t, onInviteButtonClick: s } = n.useContext(m.V);
            ...
            children:
              ...
              (0, h.jsx)(a.Z, {
                ...
                children: (0, h.jsxs)(C.S, {
                  ...
                  onClick: s,
                  children: [
                    (0, h.jsx)(u, { sx: { height: 20 } }),
                    " ",
                    (0, h.jsx)(x.Z, { id: "inviteFriends.footer.button" }),
                  ],
                }),
              }),
          });
      ...
      var v = s(91815),
        ...
        y = s(20503);
      const k = (e) => {
        let { enabled: t, onExit: s } = e;
        const { disableFullscreen: o, isFullscreen: i } = n.useContext(V.s),
          [r, l] = n.useState(!1);
        return (
          n.useEffect(() => {
            l(t);
          ...
          r && t
            ? (0, h.jsxs)("div", {
                ...
                children: [
                  ...
                  (0, h.jsx)(x.Z, { id: "dislikeFeedback.title" }),
                  (0, h.jsx)(C.S, {
                    variant: "contained",
                    sx: { width: "100%", mt: 1 },
                    onClick: function () {
                    ...
                    children: (0, h.jsx)(x.Z, { id: "dislikeFeedback.action" }),
                  }),
                ],
              })
            : null
      ...
      const H = (e) => {
        let { gameSlug: t, initialRating: s } = e;
        const [r, l] = n.useState(s),
          [d, c] = n.useState(),
          [u, C] = n.useState(!1);
        n.useEffect(() => {
          const e = (() => {
        ...
        const m = (e) => {
            switch ((p(e), c(e), e)) {
              case M.NEGATIVE:
                b.Z.dislike(),
                  l({ upVotes: s.upVotes, downVotes: s.downVotes + 1 }),
                  C(!0);
                break;
              case M.POSITIVE:
                b.Z.like(),
                  l({ upVotes: s.upVotes + 1, downVotes: s.downVotes }),
                  C(!1);
                break;
              case M.CANCEL:
                b.Z.neutral(),
                  l({ upVotes: s.upVotes, downVotes: s.downVotes }),
                  C(!1);
            }
          },
          p = (e) => {
        ...
        return (0, h.jsxs)(h.Fragment, {
          children: [
            (0, h.jsx)(a.Z, {
              title: (0, h.jsx)(x.Z, { id: "tooltip.like" }),
              placement: "top",
                    ...
                    children: [
                      ...
                      (0, h.jsx)(o.ZP, {
                        ...
                        children: (0, h.jsx)(i.w1, {
                          ...
                          children: isNaN(r.upVotes)
                            ? null
                            : j.ag.number(r.upVotes, { notation: "compact" }),
                        }),
                      }),
                    ],
                  }),
            ...
            (0, h.jsxs)(i.lp, {
              ...
              children: [
                ...
                (0, h.jsx)(a.Z, {
                  title: (0, h.jsx)(x.Z, { id: "tooltip.dislike" }),
                  placement: "top",
                  children: (0, h.jsx)("div", {
                    children: (0, h.jsx)(Z.Z, {
                      onClick: async () => {
                        d === M.NEGATIVE ? m(M.CANCEL) : m(M.NEGATIVE),
                          (0, y.Vn)();
                      },
                      ...
                      children: (0, h.jsxs)(o.ZP, {
                        ...
                        children: [
                          ...
                          (0, h.jsx)(o.ZP, {
                            ...
                            children: (0, h.jsx)(i.w1, {
                              className: "ratingLabel",
                              children: isNaN(r.downVotes)
                                ? null
                                : j.ag.number(r.downVotes, {
                                    notation: "compact",
                                  }),
                            }),
                          }),
...
`,
      ...
      const B = (e) => {
        ...
        O = () => {
          const [e, t] = (0, n.useState)(!0),
            [s, r] = (0, n.useState)(!1),
            { isFullscreen: l } = (0, n.useContext)(V.s),
            {
              userId: d,
              isFavouriteGame: c,
          ...
          return (0, h.jsxs)(h.Fragment, {
            children: [
              (0, h.jsx)(B, {
                ...
                children: (0, h.jsx)(x.Z, { id: "popper.signInToFavourite" }),
              }),
              (0, h.jsx)(a.Z, {
                title: (0, h.jsx)(x.Z, {
                  id: c
                    ? "tooltip.removeFromFavorite"
      ...
      const J = function (e) {
        ...
        return (
          ...
          (0, h.jsx)(n.Fragment, { children: n.cloneElement(t, m) })
        );
      };
      var ee = s(18104),
        te = s(32415),
        ...
        ne = s(18088);
      const oe = 30,
        ie = (0, T.ZP)("div", { shouldForwardProp: (e) => "hasMouse" !== e })(
          (e) => {
            let { hasMouse: t } = e;
            return {
              height: "calc(100% - 15px)",
              overflow: "hidden",
              ...(t && { height: "calc(60% - 15px)", marginTop: 15 }),
            };
          }
        ),
        re = (0, T.ZP)("div")((e) => {
          ...
          return {
            ...
            "&::-webkit-scrollbar": { width: 7, background: "rgb(29, 24, 40)" },
            "&::-webkit-scrollbar-thumb": { background: w.D.black[10] },
          };
        }),
        le = (0, T.ZP)("div")({
          background: w.D.black[60],
        ...
        de = (0, T.ZP)("div", { shouldForwardProp: (e) => "activeKey" !== e })(
          (e) => {
            let {
              theme: { palette: t },
              activeKey: s,
        ...
        ae = (0, T.ZP)("div")(() => ({
          ...
          position: "relative",
          margin: "auto",
          "& div": { position: "absolute", bottom: 0, height: 26, width: 31 },
          "& div:nth-child(1)": { top: 0, left: 34, paddingLeft: 9 },
          "& div:nth-child(2)": {
            left: 0,
            "&.arrow-key": { paddingTop: 3, paddingLeft: 9 },
          },
          "& div:nth-child(3)": { left: 34, paddingLeft: 9 },
          "& div:nth-child(4)": { left: 68 },
        })),
        ce = (0, T.ZP)("div", { shouldForwardProp: (e) => "isOdd" !== e })(
          (e) => {
            let { isOdd: t } = e;
            return {
              height: "auto",
              ...
              "&:hover": {
                cursor: "default",
                "& .keyboardLabel": { color: w.D.white[100] },
                "& .control-keyboard-key": { background: w.D.black[20] },
              },
              ...(t && { background: w.D.black[70] }),
            };
          }
        ),
        he = (0, T.ZP)("div", {
          ...
          let { isLabel: t, active: s, theme: n } = e;
          return {
            alignItems: "center",
            flex: 1,
            ...
            "&:last-child": { width: "40%", paddingRight: 17 },
            ...(t && {
              color: w.D.white[60],
              fontWeight: 700,
              fontSize: "1em",
            }),
            ...(s && { color: w.D.white[100] }),
          };
        }),
        ue = (0, T.ZP)("div")(() => ({
          fontSize: "0.9em",
        ...
        Ce = (0, T.ZP)("path", { shouldForwardProp: (e) => "active" !== e })(
          (e) => {
            let { active: t } = e;
            return {
              fill: w.D.white[20],
              "&:hover": {
                ...(t && { fill: w.D.white[50], cursor: "default" }),
              },
            };
          }
        ),
        xe = (0, T.ZP)("g", { shouldForwardProp: (e) => "active" !== e })(
          (e) => {
            let { active: t } = e;
            return {
              fill: w.D.white[20],
              ...(t && {
                "&:hover": { fill: w.D.white[50], cursor: "default" },
              }),
            };
          }
        ),
        me = (e) => {
          let { type: t, pressedKey: s } = e;
          if ("arrows" !== t && "wasd" !== t) return null;
          const n =
              "arrows" === t
                ? [
                    { key: "&#9650;", pressedKey: "arrowup" },
                    { key: "&#9664;", pressedKey: "arrowleft" },
                    { key: "&#9660;", pressedKey: "arrowdown" },
                    { key: "&#9654;", pressedKey: "arrowright" },
                  ]
                : [
                    { key: "W", pressedKey: "w" },
                    { key: "A", pressedKey: "a" },
              ...
              children: n.map((e, t) =>
                (0, h.jsx)(
                  de,
                  {
                    ...
                    className: o,
                    dangerouslySetInnerHTML: { __html: e.key },
                  },
                  t
                )
              ),
      ...
      class pe extends n.Component {
        constructor(e) {
          super(e),
            (this.handleKeyboardEvent = (e) => {
              this.setState({
                pressedKey:
                  e && "keydown" === e.type ? e.key.toLowerCase() : null,
              });
            }),
            (this.checkPressedKey = (e) =>
              null !== this.state.pressedKey &&
              (this.state.pressedKey === e ||
                (this.state.pressedKey.includes("arrow") &&
                  e.includes("arrow")))),
            (this.checkedPressedKeys = (e) =>
              e.some((e) => this.checkPressedKey(e.toLowerCase()))),
            (this.convertLabelToSymbol = (e) => {
              if (e.toLowerCase().includes("arrow"))
        ...
        componentDidMount() {
          this.props.detectPressedKeys &&
            (document.addEventListener("keydown", this.handleKeyboardEvent, !1),
            document.addEventListener("keyup", this.handleKeyboardEvent, !1));
        }
        ...
        render() {
          const { controls: e, hasMouse: t, locale: s } = this.props;
          return (0, h.jsxs)(ie, {
            hasMouse: t,
            children: [
              (0, h.jsxs)(o.ZP, {
                ...
                children: e.map((e, t) => {
                  ...
                  return (0, h.jsxs)(
                    ce,
                    {
                      ...
                      children: [
                        (0, h.jsx)(he, {
                          children: e.keys.map((e, t) =>
                            "wasd" === e.toLowerCase() ||
                            "arrows" === e.toLowerCase()
                              ? (0, h.jsx)(
                                  me,
                                  {
                                    type: e.toLowerCase(),
                              ...
                              : (0, h.jsx)(
                                  de,
                                  {
                                    activeKey: !(
                                      ...
                                      !this.checkPressedKey(e.toLowerCase())
                                    ),
          ...
          (0, h.jsxs)("svg", {
            ...
            children: [
              ...
              (0, h.jsxs)(xe, {
                ...
                opacity: e.hasMiddle ? 1 : 0.5,
                active: e.hasMiddle,
                onMouseEnter: e.hasMiddle
                  ? () => e.mouseEnter("middle")
                  : void 0,
      ...
      class je extends n.Component {
        constructor(e) {
          super(e),
            (this.mouseEnterMouseControls = (e) => {
              this.setState({ hoveredButton: e });
            }),
            (this.mouseLeaveMouseControls = () => {
              this.setState({ hoveredButton: null });
            }),
            (this.mouseEnterLabelControls = (e) => {
              this.setState({ hoveredLabel: e });
            }),
            (this.mouseLeaveLabelControls = () => {
              this.setState({ hoveredLabel: null });
            }),
            (this.state = { hoveredButton: null, hoveredLabel: null });
        }
        render() {
          const { controls: e, locale: t } = this.props;
          return (0, h.jsxs)("div", {
            style: { height: "40%" },
            children: [
              (0, h.jsxs)(o.ZP, {
                ...
                children: [
                  (0, h.jsx)(o.ZP, {
                    ...
                    xs: 3,
                    children: (0, h.jsx)(ue, {
                      children: (0, h.jsx)(x.Z, { id: "gameControls.mouse" }),
                    }),
                  }),
                  (0, h.jsx)(o.ZP, {
                    item: !0,
                      ...
                      return (0, h.jsxs)(
                        o.ZP,
                        {
                          ...
                          children: [
                            ...
                            (0, h.jsx)(o.ZP, { item: !0, xs: 4, children: r }),
                          ],
                        },
                        s
                      );
      ...
      const Ze = (0, T.ZP)("div")(() => ({
        ...
        we = (e) => {
          ...
          return (0, h.jsxs)(h.Fragment, {
            children: [
              t.mouse && (0, h.jsx)(fe, { controls: t.mouse, locale: s }),
              t.keyboard &&
                (0, h.jsx)(ge, {
                  controls: t.keyboard,
                  detectPressedKeys: !1,
        ...
        Le = n.forwardRef((e, t) => {
          ...
          return (0, h.jsx)(J, {
            onClickAway: (e) => {
              const t = e;
              (t.path &&
                t.path.some((e) => "game-controls-toggle-button" === e.id)) ||
                (n && n());
            },
            children: (0, h.jsxs)(Ze, {
              ref: t,
              id: "game-controls",
              style: o ? { ...i, zIndex: 3 } : i,
              children: [
                n &&
                  (0, h.jsx)(ee.Z, {
                    onClick: n,
                    ...
                    children: (0, h.jsx)(L.Z, {
                      style: { color: w.D.white[10], width: 24, height: 24 },
                    }),
                  }),
                (0, h.jsxs)(te.Z, {
                  sx: {
        ...
        Ve = n.memo(() => {
          ...
          return (0, h.jsxs)(h.Fragment, {
            children: [
              ...
              (0, h.jsx)(a.Z, {
                title: (0, h.jsx)(x.Z, { id: "tooltip.gameControls" }),
                placement: "top",
                children: (0, h.jsx)(i.lp, {
                  withImage: !0,
                  item: !0,
        ...
        ke = n.memo(() => {
          const { isFullscreen: e, disableFullscreen: t } = n.useContext(V.s);
          return (0, h.jsxs)(h.Fragment, {
            children: [
              (0, h.jsx)(a.Z, {
                title: (0, h.jsx)(x.Z, { id: "tooltip.feedback" }),
                placement: "top",
                children: (0, h.jsx)(i.lp, {
                  item: !0,
                  withImage: !0,
      ...
      const Pe = n.memo(() => {
        const {
          ...
          { theatreModeAvailable: o } = n.useContext(Ie.y),
          { gameLoadStatus: d } = n.useContext(Se.r),
          c = r.Z.isEmbeddedExternally(),
          u = (0, l.NI)(),
          C = (0, W.v)(u.source),
          m = () => !e && o,
          p = () => {
            const { fullscreen: e } = u;
            return e && "NOT_SUPPORTED" !== e;
          };
        return m() || p()
          ? (0, h.jsxs)(h.Fragment, {
              children: [
                !(0, S.U)() && !c && !C && (0, h.jsx)(i.Gd, {}),
                m() &&
                  (0, h.jsx)(a.Z, {
                    title: (0, h.jsx)(x.Z, { id: "tooltip.theatreMode" }),
                    placement: "top",
                    children: (0, h.jsx)(i.lp, {
                      item: !0,
                      withImage: !0,
      ...
      var Te = s(50009),
        Ae = s(45675);
      const Ne = n.lazy(() =>
          Promise.all([s.e(6316), s.e(6515)]).then(s.bind(s, 56515))
        ),
        Ke = n.forwardRef((e, t) => {
          let { close: s, slideEntered: o } = e;
          const [i, d] = n.useState(null),
            a = (0, l.NI)();
          n.useEffect(() => {
            const e = r.Z.crazygamesLocalizedGameUrl(
                a.locale || ne.ZW,
                (0, Te.Z)()
              ),
              t = new URL(e);
          ...
          return (0, h.jsx)(J, {
            onClickAway: (e) => {
              const t = e;
              (t.path &&
                t.path.some((e) => "qr-modal-toggle-button" === e.id)) ||
                (s && s());
            },
            children: (0, h.jsxs)(Ze, {
              ref: t,
              style: o ? { zIndex: 3 } : void 0,
              children: [
                s &&
                  (0, h.jsx)(ee.Z, {
                    onClick: s,
                  ...
                  children: [
                    ...
                    (0, h.jsxs)("div", {
                      ...
                      children: [
                        ...
                        " ",
                        a.iosFriendly && a.androidFriendly
                          ? (0, h.jsx)(Ae.cC, {
        ...
        De = n.memo(() => {
          ...
          return (0, h.jsxs)(h.Fragment, {
            children: [
              ...
              (0, h.jsx)(a.Z, {
                title: (0, h.jsx)(x.Z, { id: "tooltip.QRPlayOnMobile" }),
                placement: "top",
                children: (0, h.jsx)(i.lp, {
                  withImage: !0,
                  item: !0,
      ...
      var ze = s(87308);
      const Be = n.memo((e) => {
        let { initialRating: t } = e;
        const s = r.Z.isEmbeddedExternally(),
          n = (0, l.NI)(),
          d = (0, W.v)(n.source),
          a = () =>
            "standalone-qa" !== n.source &&
            "qa" !== n.source &&
            !(0, S.U)() &&
            !s;
        return (0, h.jsxs)(o.ZP, {
          ...
          children: [
            (0, h.jsx)(p, {}),
            a() && (0, h.jsx)(H, { initialRating: t, gameSlug: n.gameSlug }),
            a() && (0, h.jsx)(O, {}),
            !s && !d && (0, h.jsx)(i.Gd, {}),
            (0, h.jsx)(Fe.Z, {}),
            !(0, S.U)() && !s && "en_US" === n.locale && (0, h.jsx)(ke, {}),
            !(0, S.U)() &&
              n.controls &&
              Object.keys(n.controls).length > 0 &&
              (0, h.jsx)(Ve, {}),
            !(0, ze.uo)() &&
              (n.androidFriendly || n.iosFriendly) &&
              (0, h.jsx)(De, {}),
            (0, h.jsx)(Pe, {}),
          ],
        });
