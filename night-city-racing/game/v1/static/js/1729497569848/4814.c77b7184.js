...
(self.webpackChunkcrazygames_gameframe =
  ...
  [4814, 6544],
  {
    ...
    26544: (e, t, a) => {
      a.r(t), a.d(t, { GAME_FILES_DOMAIN: () => u, default: () => h });
      var s = a(47313),
        n = a(95681),
        r = a(23004),
        o = a(90831),
      ...
      class c extends s.Component {
        ...
        componentDidUpdate(e) {
          e.isFullscreen !== this.props.isFullscreen && this.focusOnIframe(),
            !e.isGameDisabled && this.props.isGameDisabled
              ? this.disableIframe()
              : e.isGameDisabled &&
                !this.props.isGameDisabled &&
                this.restartGame();
        }
        render() {
          return null;
        ...
        loadIframe() {
          ...
          (e.src = this.getIframeUrl()),
            ...
            e.setAttribute(
              "allow",
              `accelerometer; gyroscope; autoplay; payment; fullscreen; microphone; clipboard-read; clipboard-write 'self' ${this.getIframeUrl()}`
            ),
            e.setAttribute("webkitallowfullscreen", "true"),
            e.setAttribute("mozallowfullscreen", "true"),
            e.setAttribute("msallowfullscreen", "true"),
        ...
        getIframeUrl() {
          ...
          return (
            ...
            e.loaderLocation && n.searchParams.set(r, e.loaderLocation),
            n.toString()
          );
        }
        focusOnIframe() {
    ...
    54814: (e, t, a) => {
      ...
      const g = (e) => {
        ...
        const { gameLoadStatus: u } = s.useContext(h.r),
          { setIsGameDisabled: g } = s.useContext(c.F),
          { hasUserLoaded: p, userId: f } = s.useContext(n.NL),
          v = s.useRef("initial"),
          w = "NOT_STARTED" !== u,
          y = s.useCallback(
            (e, t, a) => {
        ...
        return (
          ...
          s.useEffect(() => {
            const e = async (e) => {
              d.debug("has user: ");
              try {
                if (((0, m.Dy)({ type: "load", status: "start" }), o.GX))
                  return;
                if (o.KQ) return void y("failed");
                const s = await i();
                if ("aborted" === s.result || "resolvingGameData" !== v.current)
                  return;
                if (s.gameData) {
      ...
      const j = (e) => {
          ...
          null === (t = x) ||
            ...
            void 0 === a ||
            a.postMessage({ type: s, data: n }, "*");
        },
        C = (e, t) => {
          S ? j({ type: e, data: t }) : D.push({ type: e, data: t });
        },
        b = async (e, t) =>
          new Promise((a, s) => {
            const n = document.createElement("iframe");
            (n.src = (0, o.z6)((0, p.NI)().gameSlug, e, (0, o.VB)(), t)),
        ...
        T = async (e) => {
          const t = e.metadata.updatedAt.includes("T")
              ? "yyyy-MM-dd'T'HH:mm:ss.SSSX"
              : "yyyy-MM-dd HH:mm:ss",
            a = (0, y.Z)(e.metadata.updatedAt, t, new Date()),
            s = (0, v.Z)((0, w.Z)(a, -a.getTimezoneOffset()), "T"),
            n = { ...e, metadata: { ...e.metadata, updatedAtTz: s } };
          return (
            C("requestGameDataResponse", n),
            new Promise((e) => {
              const t = (a) => {
                const { type: s } = a.data;
                "loadGame" === s &&
      ...
      const I = class {
        constructor(e) {
          (this.onBroadCastDisable = void 0),
            ...
            (this.disableState = () => {
              "disabled" !== this.state &&
                ((this.state = "disabled"), this.onBroadCastDisable());
            }),
        ...
        sendJoinedMessage() {
          this.state = "enabled";
          this.broadcastChannel.postMessage({ key: "joined", keyData: {} });
        }
      };
      var k = a(42379),
        Z = a(26625),
      ...
      const L = (0, k.ZP)("div")({
        ...
        F = (0, k.ZP)(Z.Z)({ fill: R.D.brand[60], height: 48, width: 48 }),
        U = (0, k.ZP)(P.Z)({ fill: R.D.white[100], height: 64, width: 64 }),
        N = (0, k.ZP)("div")((e) => {
          let {
            theme: { spacing: t },
          } = e;
        ...
        O = (0, k.ZP)("span")({ color: R.D.brand[60] }),
        q = (0, k.ZP)("span")({ fontWeight: 700 }),
        z = (0, k.ZP)(G.S)((e) => {
          let { theme: t } = e;
          return {
      ...
      const _ = s.memo((e) =>
              ...
              (0, J.jsx)(M, {
                ...
                children: (0, J.jsxs)(A, {
                  ...
                  children: [
                    (0, J.jsxs)("div", {
                      children: [
                        (0, J.jsx)(_, { sx: { width: 70, height: 70 } }),
                        (0, J.jsx)(K, {
                          sx: { width: 30, height: 70, mx: 1.5 },
                        }),
                        (0, J.jsx)(_, { sx: { width: 70, height: 70 } }),
                      ],
                    }),
                    (0, J.jsx)(N, {
                      children: (0, J.jsx)($.Z, { id: "aps.newTab.title" }),
                    }),
                    (0, J.jsx)(H, {
                      children: (0, J.jsx)($.Z, {
                        id: "aps.newTab.text",
                        values: {
                          secondaryButton: (0, J.jsx)(q, {
                            children: (0, J.jsx)($.Z, {
        ...
        W = s.createContext({ onSaveVersionConflict: () => {} }),
        X = W;
      var Y = a(34207),
        ee = a(74821);
      const te = (e) => {
        let { onReload: t, onEnable: a } = e;
              ...
              children: (0, J.jsxs)(A, {
                ...
                children: [
                  (0, J.jsxs)("div", {
                    children: [
                      (0, J.jsx)(_, { sx: { width: 70, height: 70 } }),
                      (0, J.jsx)(K, { sx: { width: 30, height: 70, mx: 1.5 } }),
                      (0, J.jsx)(ee.Z, { sx: { width: 70, height: 70 } }),
                    ],
                  }),
                  (0, J.jsx)(N, {
                    children: (0, J.jsx)($.Z, {
      ...
      let ae = !1;
      const se = (e) => {
        let { children: t, onForceSave: a } = e;
        const [n, r] = s.useState("normal"),
          { setIsGameDisabled: o } = s.useContext(c.F),
          i = s.useRef(null),
          l = s.useRef(),
          d = s.useCallback((e) => {
        ...
        s.useEffect(() => {
          if (ae)
            throw new Error("APSBroadcast is sending joined message twice");
          ae = !0;
          (i.current = new I(() => {
            o(!0), r("error-newTab");
          })),
        ...
        const u = () => {
          ...
          h = () => {
            E.Z.redirectToHomepage();
          },
          m = async () => {
            await a(l.current), r("normal");
          };
        return (0, J.jsx)(W.Provider, {
          value: { onSaveVersionConflict: d },
          children:
            "error-newTab" === n
              ? (0, J.jsx)(Q, { onReload: u, onHomepage: h })
              : "error-versionConflict" === n
              ? (0, J.jsx)(te, { onReload: u, onEnable: m })
        ...
        execute(e) {
          return new Promise((t, a) => {
            this.currentExecution
              ? (this.nextExecution &&
                  this.nextExecution.reject(
                    new oe("Execution discarded due to new request")
                  ),
                (this.nextExecution = { fn: e, resolve: t, reject: a }))
        ...
        async executeNext(e, t, a) {
          ...
          try {
            if ((t(await this.currentExecution), this.nextExecution)) {
              const { fn: e, resolve: t, reject: a } = this.nextExecution;
      ...
      class de {
        ...
        async throttledExecute(e) {
          ...
          for (let s = 0; s < 3; s++) {
            ...
            if ("ok" === o.status) return { status: "ok", result: o.result };
            if (o.error instanceof oe) return { status: "throttled" };
            if (e.throwOnError && e.throwOnError(o.error))
              return { status: "error", error: o.error };
            const l = 1e4 - i;
            if (this.intervalRequestData[e.key] !== t)
              return (
                re.Z.getInstance().sendEvent({
                  type: "apsIssue",
                  issueType: "runtime-save-fail",
                  loaderName: (0, p.NI)().loader,
                  hasUserLoaded: n.vN,
                  hasScriptLoaded: !1,
                  jsondata: JSON.stringify({ attempt: s + 1 }),
                }),
          ...
          return (
            re.Z.getInstance().sendEvent({
              ...
              hasUserLoaded: n.vN,
              hasScriptLoaded: !1,
              jsondata: JSON.stringify({ attempt: 3 }),
            }),
      ...
      class ce {
        constructor(e, t) {
          (this.key = void 0),
            ...
            (this.key = "saveSdkGameData"),
            (this.fn = () => ue.n.Instance.saveSdkGameData(e, t)),
            (this.throwOnError = (e) => {
              var t, a;
              const s =
                e instanceof ue.J &&
      ...
      class he {
        constructor(e, t) {
          (this.key = void 0),
            (this.fn = void 0),
            (this.throwOnError = void 0),
            (this.key = "replaceGameData"),
            (this.fn = () => ue.n.Instance.replaceGameData(e, t)),
            (this.throwOnError = (e) => {
              var t, a;
              const s =
                e instanceof ue.J &&
      ...
      class me {
        constructor(e) {
          (this.key = void 0),
            (this.fn = void 0),
            (this.key = "clearGameData"),
            (this.fn = () => ue.n.Instance.clearGameData(e));
        }
      }
      const ge = () => {
          const { onSaveVersionConflict: e } = s.useContext(X);
          return (
            s.useEffect(() => {
              const t = async (t) => {
                var a, s;
                try {
                  ...
                  switch (n) {
                    case "replaceGameData":
                      const n = await de.Instance.throttledExecute(
                        new he(t.data.data)
                      );
                      "error" === n.status &&
                        n.error instanceof ue.J &&
                        (null === (a = n.error.result) ||
                        void 0 === a ||
                        null === (s = a.errors) ||
                        void 0 === s
                          ? void 0
              ...
              (0, J.jsx)(M, {
                ...
                children: (0, J.jsxs)(A, {
                  ...
                  children: [
                    (0, J.jsx)(F, {}),
                    (0, J.jsx)(N, {
                      children: (0, J.jsx)($.Z, { id: "aps.reload.title" }),
                    }),
                    (0, J.jsx)(H, {
                      children: (0, J.jsx)($.Z, {
                        id: "aps.reload.text",
      ...
      const ve = (e) => {
        let { children: t } = e;
        const { adState: a } = s.useContext(fe.g),
          [n, r] = s.useState(!0);
        return (
          s.useEffect(() => {
            "playing" === a.state ? r(!1) : r(!0);
          }, [a]),
          n ? (0, J.jsx)(J.Fragment, { children: t }) : null
        );
      };
      var we = a(69121);
      function ye(e, t, a) {
      ...
      const Se = (e) => {
          let { onReload: t, onContinue: a, source: n, onShow: r } = e;
          const o = (0, we.Tb)(),
            [i, l] = s.useState(!1);
          return (
            (0, s.useEffect)(() => {
                ...
                (0, J.jsx)(M, {
                  children: (0, J.jsxs)(A, {
                    ...
                    children: [
                      ...
                      (0, J.jsxs)(H, {
                        children: [
                          (0, J.jsx)($.Z, { id: "aps.notLoaded.text" }),
                          o.isIos &&
                            o.isSafari &&
                            (0, J.jsx)($.Z, {
                        ...
                        children: [
                          ...
                          (0, J.jsx)(z, {
                            ...
                            children: i
                              ...
                              : (0, J.jsx)($.Z, { id: "aps.notLoaded.reload" }),
                          }),
                        ],
                      }),
                    ],
        ...
        xe = (e) => {
          let { onStatusChange: t, userStatus: a } = e;
          const n = s.useRef(),
            { gameLoadStatus: r } = s.useContext(h.r),
            o = "NOT_STARTED" !== r,
            i = s.useCallback(() => {
              const e = window.setTimeout(() => {
                t("userTimeoutTriggered");
              }, 7e3);
              t("userTimeoutStarted"),
                (n.current = { timeout: "userTimeoutStarted", timeoutId: e });
            }, [t]),
            l = s.useCallback(() => {
              const e = window.setTimeout(() => {
                t("gameDataTimeoutTriggered");
              }, 7e3);
              t("gameDataTimeoutStarted"),
                (n.current = {
            ...
            d = s.useCallback(() => {
              ...
              null !== (e = n.current) &&
                void 0 !== e &&
                e.timeoutId &&
                window.clearTimeout(n.current.timeoutId);
            }, []);
          return (
            s.useEffect(() => {
              if (o)
        ...
        De = (e) => {
          let { onDeleteProgressRequest: t } = e;
          const { setIsGameDisabled: a } = s.useContext(c.F);
          return (
            s.useEffect(() => {
              const e = (e) => {
                e.data &&
                  "deleteProgressRequest" === e.data.type &&
                  (a(!0), t());
              };
              return (
      ...
      class je extends s.PureComponent {
        constructor(e) {
          super(e),
            (this.context = void 0),
            (this.logger = (0, l.fq)((0, o.Qg)()).withPrefix("[APS-Iframe]")),
            (this.processAPSInterjectorGameDataInitMessage = async (e) => {
              const { type: t } = e.data;
              "replaceInitGameData" === t &&
                (await de.Instance.throttledExecute(new he(e.data.data)));
            }),
            (this.popupShowing = (e) => {
              this.setState({ popupCurrentlyShowing: e });
            }),
            (this.onFailure = () => {
              var e;
              (0, o.zg)(),
                null === (e = i.Z.Instance.getDeferred()) ||
                  void 0 === e ||
                  e.resolve(),
                (0, m.Dy)({ type: "load", status: "end", success: !1 });
            }),
            (this.onGameDataMissingContinue = () => {
              this.setState({ userStatus: "failed-gameData-missing" }),
                this.onFailure();
            }),
            (this.onUserMissingContinue = () => {
              this.setState({ userStatus: "failed-user-missing" }),
                this.onFailure();
            }),
            (this.onSelectReload = () => {
              E.Z.refreshGamePage();
            ...
            (this.onDeleteProgress = async () => {
              const e = (t) => {
                t.data &&
                  "deleteProgressRequestResponse" === t.data.type &&
                  (E.Z.deleteProgressRequestResponse(),
                  window.removeEventListener("message", e));
              };
              window.addEventListener("message", e), C("deleteProgressRequest");
            }),
            (this.loadApsInterjector = () => b(this.props.loader)),
            (this.handleTimeoutStateChange = (e) => {
              if (!this.state.popupCurrentlyShowing)
                switch (e) {
                  case "userTimeoutTriggered":
                    this.setState({ userStatus: "userTimeout-popup" });
                    break;
                  case "gameDataTimeoutStarted":
                    "userTimeout-popup" === this.state.userStatus &&
                      this.setState({ userStatus: "pending" });
                    break;
                  case "gameDataTimeoutTriggered":
                    this.setState({ userStatus: "gameDataTimeout-popup" });
                }
            }),
            (this.handleStateChange = (e, t, a) => {
              ...
              switch (e) {
                case "resolvingGameData":
                  this.logger.debug("resolving game data: "),
                    this.setState({ userStatus: "resolving" });
                  break;
                case "noUser":
                  this.logger.debug("has no user: "),
                    this.setState({ userStatus: "none" }),
                    null === (s = i.Z.Instance.getDeferred()) ||
                      void 0 === s ||
                      s.resolve();
                  break;
                case "reload-popup":
                  this.setState({ userStatus: "reload-popup" });
                  break;
                case "resolvedGameData":
                  let e;
                  if (
                    (this.setState({ userStatus: "normal" }),
                    null === (n = i.Z.Instance.getDeferred()) ||
                      void 0 === n ||
                      n.resolve(),
                    null !== t &&
                      void 0 !== t &&
                  ...
                  break;
                case "failed":
                  (0, o.Ho)(this.state.userStatus, a),
                    this.setState({ userStatus: "failed-unknown" }),
                    this.onFailure();
              }
            }),
            ...
            this.logger.debug(`enabled version ${o.bs}`),
            (this.state = {
              userStatus: "pending",
        ...
        componentDidMount() {
          (0, o.VO)("Loading Iframe loader"),
            this.onPreloadGame(),
            window.addEventListener(
              "message",
              this.processAPSInterjectorGameDataInitMessage
            ),
            this.loadApsInterjector().catch((e) => {
        ...
        componentDidUpdate() {
          this.state.userStatus !== i.Z.Instance.getApsUserStatus() &&
            i.Z.Instance.setApsUserStatus(this.state.userStatus);
        }
        render() {
          ...
          return (0, J.jsxs)(J.Fragment, {
            children: [
              (0, J.jsx)(g, {
                ...
                forceStop:
                  "failed-unknown" === e ||
                  "failed-user-missing" === e ||
                  "failed-gameData-missing" === e,
                logger: this.logger,
              }),
              (0, J.jsx)(xe, {
              ...
              "reload-popup" === e &&
                (0, J.jsx)(ve, {
                  children: (0, J.jsx)(pe, { onReload: this.onSelectReload }),
                }),
              "userTimeout-popup" === e &&
                (0, J.jsx)(ve, {
                  children: (0, J.jsx)(Se, {
      ...
      var be = a(41989),
        ...
        Ge = a(97703),
        Re = a(97771);
      const Pe = new Ge.Z("unityApsReady"),
        Le = "/idbfs",
        Me = "FILE_DATA";
      let Ae;
      const Fe = (e) => +new Date(e),
        Ue = () => {
          const { apsSyncTimerMs: e } = (0, p.NI)();
          return e || 3e4;
        },
        Ne = () => window.indexedDB,
        He = () => {
        ...
        qe = (e) => {
          ...
          let s;
          (s = t.objectStoreNames.contains(Me)
            ? a.objectStore(Me)
            : t.createObjectStore(Me)),
            s.indexNames.contains("timestamp") ||
              s.createIndex("timestamp", "timestamp", { unique: !1 });
        },
        ze = (e, t) =>
          new Promise((a, s) => {
            e.transaction(Me).objectStore(Me).get(t).onsuccess = (e) => {
              try {
                const s = e.target.result;
                if (!s) return a(null);
                if (!s.timestamp)
                  return (
                    console.error("[APS-U] IDB data incomplete: " + t + s),
                    a(null)
                  );
        ...
        Be = () => {
          const e = Ne().open(Le, 21);
          return new Promise((t, a) => {
            (e.onupgradeneeded = qe),
              (e.onsuccess = () => {
                const s = e.result,
                  n = Oe(),
                  r = s.transaction(Me),
                    ...
                    if (s) {
                      ...
                      t.getTime() >
                        ((null === (n = l) || void 0 === n
                          ? void 0
                          : n.getTime()) || 0) && (l = t);
                      const o = { ...s, timestamp: Fe(s.timestamp) };
                      s.contents &&
                        (o.contents = ((r = s.contents), (0, Ee.hd)(r))),
                        (i[e] = o);
                    }
                    var r;
                  };
        ...
        $e = (e) => {
          const t = Ne().open(Le, 21);
          return new Promise((a, s) => {
            (t.onupgradeneeded = qe),
              (t.onsuccess = () => {
                const n = t.result.transaction(Me, "readwrite"),
                  r = He();
                e &&
                  Object.entries(e).forEach((t) => {
                    ...
                    const d = { ...o, timestamp: new Date(o.timestamp) };
                    var u;
                    d.contents &&
                      (d.contents =
                        ((u = d.contents), new Uint8Array((0, Ee.fJ)(u)))),
                      n.objectStore(Me).put(d, l);
                  }),
                  (n.oncomplete = () => {
                    a(null);
                  }),
        ...
        Je = async (e, t, a) => {
          if (!e) return null;
          const { data: s, updatedAtTz: n } = e;
          if (!s || !(!t || n !== Ae)) return null;
          Ae = n;
          const r = Ze.Z.getGameTimeInSec();
          ((e) => {
            const { gameSlug: t } = (0, p.NI)();
            Ie.m.Instance.setItem(`_czy_${t}_pt`, `${e}`);
          })(r);
          return await de.Instance.throttledExecute(
            new he(
              { store: s, version: (0, le.Z)(), updatedAtTz: n, playedTime: r },
              a
            )
          );
        },
        _e = async (e, t) => {
          ...
          if (!n)
            return (
              null === t || void 0 === t || t.debug("no local"),
              void (await Ve(e, s))
            );
          if (n === s)
            return null === t || void 0 === t || t.debug("same"), void (Ae = n);
          if (n > s && n - s < Ue()) {
            null === t || void 0 === t || t.debug("choosing LS", n, s);
            const e = await Ke();
            await Je(e, !1);
          } else
            null === t || void 0 === t || t.debug("choosing API"),
              await Ve(e, s);
        },
        Ke = async () => (Re.m ? Be() : Ye()),
        Qe = async () =>
            ...
            ? (() => {
                ...
                return new Promise((t, a) => {
                  (e.onupgradeneeded = qe),
                    (e.onsuccess = async () => {
                      const a = e.result;
                      a.objectStoreNames.contains(Me) ||
                        a.createObjectStore(Me);
                      const s = Oe();
                      let n = await ze(a, s[1]);
                      n || (n = await ze(a, s[0])), t(n);
                    }),
                    (e.onerror = (e) => {
        ...
        Xe = async () =>
          Re.m
            ...
            : at(),
        Ye = async () => {
          Pe.sendMessage({ type: "getExistingIndexedData" });
          return await Pe.receiveMessage("getExistingIndexedDataResult");
        },
        et = async () => {
          Pe.sendMessage({ type: "getUpdatedAtTz" });
          return await Pe.receiveMessage("getUpdatedAtTzResult");
        },
        tt = async (e) => {
          Pe.sendMessage({ type: "installUnityGameData", gameData: e });
          return await Pe.receiveMessage("installUnityGameDataResult");
        },
        at = async () => {
          Pe.sendMessage({ type: "deleteProgressRequest" });
          return await Pe.receiveMessage("deleteProgressRequestResponse");
        },
        st = () => {
          const { onSaveVersionConflict: e } = s.useContext(X);
          return (
            ...
            s.useEffect(
              () => (
                i.Z.Instance.setCachedSyncUnityData(async () => {
                  var t, a;
                  const s = await Ke(),
                    n = await Je(s, !0);
                  n &&
        ...
        nt = (e) => {
          let { logger: t } = e;
          const { onSaveVersionConflict: a } = s.useContext(X),
            n = s.useRef(!1),
            r = s.useRef(!1),
            i = s.useRef(0);
          return (
            s.useEffect(() => {
              const e = async () => {
                  ...
                  d &&
                    "error" === d.status &&
                    d.error instanceof ue.J &&
                    null !== (t = d.error.result) &&
                    void 0 !== t &&
                    null !== (s = t.errors) &&
                    void 0 !== s &&
                    s.some((e) => {
                ...
                s = async (a) => {
                  try {
                    const { type: s } = a.data;
                    if ("syncUnityGameData" === s)
                      t.debug("syncUnityGameData requested"), e();
                  } catch (s) {
                    (n.current = !1),
                      (r.current = !1),
        ...
        rt = (e) => {
          let { logger: t } = e;
          return (0, J.jsxs)(J.Fragment, {
            children: [(0, J.jsx)(st, {}), (0, J.jsx)(nt, { logger: t })],
          });
        };
      var ot = a(74007),
        it = a(46858);
      class lt extends s.PureComponent {
        constructor(e) {
          super(e),
            (this.context = void 0),
            (this.logger = (0, l.fq)((0, o.Qg)()).withPrefix("[APS-Unity]")),
            (this.popupShowing = (e) => {
              this.setState({ popupCurrentlyShowing: e });
            }),
            (this.onDeleteProgressRequest = async () => {
              await Xe(), E.Z.deleteProgressRequestResponse();
            }),
            (this.onFailure = () => {
              var e;
              (0, o.zg)(),
            ...
            (this.loadApsInterjector = () => {
              const e = (0, it.l)();
              if ("unity56" === e) return b("unity", (0, ot.z)("unity56"));
              if ("unity2020" === e) return b("unity", (0, ot.z)("unity2020"));
          ...
          return (0, J.jsxs)(J.Fragment, {
            children: [
              ...
              "normal" === e &&
                ...
                (0, J.jsx)(se, {
                  onForceSave: this.onForceSave,
                  children: (0, J.jsx)(rt, { logger: this.logger }),
                }),
              "reload-popup" === e &&
                (0, J.jsx)(ve, {
                  children: (0, J.jsx)(pe, { onReload: this.onSelectReload }),
      ...
      lt.contextType = n.NL;
      const dt = (0, d.T)((0, d.q)((0, u.xf)(lt))),
        ut = () => {
          const { onSaveVersionConflict: e } = s.useContext(X);
          return (
            s.useEffect(() => {
              const t = (t) => {
                ...
                try {
                  const { type: s } = t.data;
                  if ("saveSdkGameData" === s)
                    (async (t) => {
                      var a, s, n, r;
                      (0, m.Dy)({ type: "save", status: "start" });
                      const o = await de.Instance.throttledExecute(new ce(t));
                      switch (o.status) {
                        case "ok":
                          (0, m.Dy)({
                            type: "save",
                        ...
                        case "throttled":
                          break;
                        case "error":
                          o.error instanceof ue.J &&
                            null !== (a = o.error.result) &&
                            void 0 !== a &&
                            null !== (s = a.errors) &&
                            void 0 !== s &&
                            s.some((e) => {
        ...
        ct = (e) => {
          let { onError: t, loader: a, unityRawIDBId: n } = e;
          return (
            s.useEffect(() => {
              b(a, n).catch((e) => {
                t(e);
      ...
      var ht = a(76306);
      const mt = (0, l.fq)((0, o.Qg)()).withPrefix("[APS-SDKPS]");
      function gt() {
        const e = (0, p.NI)().loader;
        return p.h4.includes(e) && (0, o.x3)()
          ? "iframe"
          : "ruffle" === e && (0, o.o5)()
          ? "ruffle"
          : p.Fw.includes(e) && (0, o.v9)()
          ? "unity"
          : null;
      }
      const pt = () => {
          const { gameLoadStatus: e } = s.useContext(h.r),
            [t, a] = s.useState(!1),
            [n, d] = s.useState("pending"),
            [u, c] = s.useState(),
            p = s.useRef({ status: "loading" }),
            f = s.useRef([]),
            v = s.useRef(),
            S = "NOT_STARTED" !== e;
          i.Z.Instance.getDeferred() || i.Z.Instance.setDeferred((0, r.PQ)()),
            s.useEffect(() => {
              ...
              const e = (e) => {
                try {
                  ...
                  if ("requestSdkGameDataNew" === t)
                    f.current.push(e.source), b();
                } catch (t) {
                  mt.error("Failed to handle requestSdkGameDataNew", t);
                }
              };
              return (
                window.addEventListener("message", e),
          ...
          const x = (e) => {
              ...
              switch (e) {
                case "resolvedGameData":
                case "noUser":
                  null === (t = v.current) || void 0 === t || t.resolve();
                  break;
                case "failed":
                  null === (a = v.current) ||
                    void 0 === a ||
                    a.reject(new Error("apsLoad-failed"));
              }
            },
            D = () => {
              var e;
              null === (e = v.current) ||
                void 0 === e ||
                e.reject(new Error("apsLoad-failed"));
            };
          const j = () => {
              const e = (0, it.l)();
              if ("unity56" === e) return (0, ot.z)("unity56");
              if ("unity2020" === e) return (0, ot.z)("unity2020");
              throw new Error("Not supported unity version");
            },
            C = () => {
              E.Z.refreshGamePage();
            ...
            b = () => {
              p.current &&
                0 !== f.current.length &&
                (f.current.forEach((e) => {
                  ("loaded" !== p.current.status &&
                    "failed" !== p.current.status) ||
                    (e.postMessage(
                      { type: "sdkGameDataResponseNew", data: p.current },
                      "*"
                    ),
                    mt.debug("Sending game data to SDK", p.current));
                }),
                (f.current = []));
            },
            I = (e) =>
              e instanceof Error && "forceApsGameDataFail" === e.message
                ? (E.Z.sendSDKError({
                  ...
                  void mt.error("Failed to load SDKPS data URL", e))
                : e instanceof ht.W
                ? (E.Z.sendSDKError({
                    errorName: "gf-preload-url-fail",
                    module: "data",
                ...
                : void (
                    e instanceof Error &&
                    ("fetch-fail" === e.message || "TimeoutError" === e.name) &&
                    (E.Z.sendSDKError({
                    ...
                    mt.error("Failed to load SDKPS data JSON", e))
                  ),
            k = s.useCallback(
              (e) => {
                if (!u)
          ...
          return (0, J.jsxs)(J.Fragment, {
            children: [
              (0, J.jsx)(xe, { onStatusChange: k, userStatus: n }),
              (0, J.jsx)(g, {
                handleGetUserGameData: o.mT,
                handleEmptyGameData: async () => {
                  gt() &&
                    (a(!0), (v.current = (0, r.PQ)()), await v.current.promise),
                    (p.current = { hasData: !1, status: "loaded" }),
                    b(),
                    (0, m.Dy)({ type: "load", status: "end", success: !0 });
                },
                handleGameData: async (e) => {
                  (p.current = { data: e.data, hasData: !0, status: "loaded" }),
                    b(),
                    (0, m.Dy)({
                      type: "load",
                      status: "end",
                ...
                handleStateChange: (e, t, a) => {
                  ...
                  switch (e) {
                    ...
                    case "resolvedGameData":
                      ...
                      break;
                    case "failed":
                      I(a), d("failed-unknown"), G();
                  }
                },
                forceStop:
                  "failed-unknown" === n ||
                  "failed-user-missing" === n ||
                  "failed-gameData-missing" === n,
                logger: l.kg,
              }),
              (0, J.jsx)(De, {
                onDeleteProgressRequest: async () => {
                  await new ce({ jsonData: "{}" }, !0).fn(),
                    E.Z.deleteProgressRequestResponse();
                },
              }),
              t &&
                    ...
                    case "iframe":
                      return (0, J.jsxs)(J.Fragment, {
                        children: [
                          ...
                          (0, J.jsx)(ct, { onError: D, loader: "iframe" }),
                        ],
                      });
                    case "ruffle":
                      return (0, J.jsxs)(J.Fragment, {
                        children: [
                          ...
                          (0, J.jsx)(ct, { onError: D, loader: "ruffle" }),
                        ],
                      });
                    case "unity":
                      const e = j();
              ...
              "reload-popup" === n &&
                (0, J.jsx)(ve, { children: (0, J.jsx)(pe, { onReload: C }) }),
              "userTimeout-popup" === n &&
                (0, J.jsx)(ve, {
                  children: (0, J.jsx)(Se, {
                    source: "userTimeout-popup",
                    ...
                    onShow: Z,
                    onContinue: () => {
                      d("failed-user-missing"), G();
                    },
                  }),
                }),
              "gameDataTimeout-popup" === n &&
                (0, J.jsx)(ve, {
                  children: (0, J.jsx)(Se, {
                    source: "gameDataTimeout-popup",
                    onReload: C,
        ...
        ft = () => {
          const { progressSyncHandler: e } = s.useContext(m.B4);
          switch (e) {
            case "none":
              return null;
            case "sdkps":
              return (0, J.jsx)(pt, {});
            case "aps-iframe":
              return (0, J.jsx)(Ce, { loader: "iframe" });
            case "aps-ruffle":
              return (0, J.jsx)(Ce, { loader: "ruffle" });
            case "aps-unity":
              return (0, J.jsx)(dt, {});
            default:
      ...
      const n = class {
        constructor(e) {
          (this.readyMessage = e),
            ...
            (this.sendMessage = (e) => {
              this.windowSource
                ? this.windowSource.postMessage(e, "*")
                : this.queuedMessages.push(e);
            }),
            (this.receiveMessage = async (e) => {
              const t = (0, s.PQ)();
              this.messageListeners.push({ promise: t, messageType: e });
              return await t.promise;
            }),
            (this.onMessage = (e) => {
              e.data.type === this.readyMessage &&
                ((this.windowSource = e.source),
                this.queuedMessages.forEach((e) => {
                  var t;
                  return null === (t = this.windowSource) || void 0 === t
                    ? void 0
                    : t.postMessage(e, "*");
                })),
                this.messageListeners.forEach((t) => {
                  t.messageType === e.data.type &&
                    (e.data.isSuccessful
                      ? t.promise.resolve(e.data.result)
                      : t.promise.reject(
                          new Error(`WindowMessenger:${e.data.type} failed`)
                        ));
                });
            }),
      ...
      function o(e) {
        const t = (0, n.NI)(),
          a = r
            ...
            : `https://${t.gameSlug}.${s.GAME_FILES_DOMAIN}`;
        switch (e) {
          case "unity2020":
