...
export class ConfigHelper {
    ...
    static injectDefaultsIntoPromptOptions(promptOptions, defaultsFromServer, wholeUserConfig, isUsingSubscriptionWorkaround = false) {
        ...
        const promptOptionsConfig = Object.assign(Object.assign({}, promptOptions), {
            customlink: {
        ...
        if (promptOptionsConfig.slidedown) {
            promptOptionsConfig.slidedown.prompts = (_b = (_a = promptOptionsConfig.slidedown) === null || _a === void 0 ? void 0 : _a.prompts) === null || _b === void 0 ? void 0 : _b.map(promptOption => {
                ...
                if (promptOption.type === DelayedPromptType.Category) {
                    promptOption.text = Object.assign(Object.assign({}, promptOption.text), {
                        positiveUpdateButton: Utils.getValueOrDefault((_a = promptOption.text) === null || _a === void 0 ? void 0 : _a.positiveUpdateButton, SERVER_CONFIG_DEFAULTS_SLIDEDOWN.categoryDefaults.positiveUpdateButton),
                        negativeUpdateButton: Utils.getValueOrDefault((_b = promptOption.text) === null || _b === void 0 ? void 0 : _b.negativeUpdateButton, SERVER_CONFIG_DEFAULTS_SLIDEDOWN.categoryDefaults.negativeUpdateButton),
                        updateMessage: Utils.getValueOrDefault((_c = promptOption.text) === null || _c === void 0 ? void 0 : _c.updateMessage, SERVER_CONFIG_DEFAULTS_SLIDEDOWN.categoryDefaults.updateMessage)
                    });
                }
                promptOption.text = Object.assign(Object.assign({}, promptOption.text), {
                    actionMessage: Utils.getValueOrDefault((_d = promptOption.text) === null || _d === void 0 ? void 0 : _d.actionMessage, SERVER_CONFIG_DEFAULTS_SLIDEDOWN.actionMessage),
                    acceptButton: Utils.getValueOrDefault((_e = promptOption.text) === null || _e === void 0 ? void 0 : _e.acceptButton, SERVER_CONFIG_DEFAULTS_SLIDEDOWN.acceptButton),
                    cancelButton: Utils.getValueOrDefault((_f = promptOption.text) === null || _f === void 0 ? void 0 : _f.cancelButton, SERVER_CONFIG_DEFAULTS_SLIDEDOWN.cancelButton),
                    confirmMessage: Utils.getValueOrDefault((_g = promptOption.text) === null || _g === void 0 ? void 0 : _g.confirmMessage, SERVER_CONFIG_DEFAULTS_SLIDEDOWN.confirmMessage)
                });
        ...
        switch (integrationCapabilities.configuration) {
            ...
            case IntegrationConfigurationKind.JavaScript:
                ...
                */
                ...
                const config = Object.assign(Object.assign(Object.assign(Object.assign({}, userConfig), {
                    promptOptions: this.injectDefaultsIntoPromptOptions(userConfig.promptOptions, serverConfig.config.staticPrompts, userConfig, isUsingSubscriptionWorkaround)
                }), {
