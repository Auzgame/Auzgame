(function() {
    ...
    function z(a, b, c) {
        if (b) a: {
            ...
            d = d[d.length - 1];c = ca && "es6" === c ? f[d] : null;b = b(c);null != b && (a ? l(w, d, {
                ...
                writable: !0,
                value: b
            }) : b !== c && (void 0 === da[d] && (a = 1E9 * Math.random() >>> 0, da[d] = ca ? r.Symbol(d) : "$jscp$" + a + "$" + d), l(f, da[d], {
                configurable: !0,
                writable: !0,
                value: b
            })))
    ...
    */
    ...
    function ad(a, b, c, d, e, f) {
        ...
        if (c) {
            if (a.top == a) var t = 0;
                ...
                if (J) t = J[J.length - 1] == a.location.origin ? 1 : 2;
                else {
                    J = a.top;
                    try {
                        var A;
            ...
            A = Ub ? Ub : 1 == t ? a.top.location.href : a.location.href;
            ua += T("frm", t);
            ua += T("url", Uc(A));
            ua += T("ref", Uc(vd || c.referrer))
        }
        a = [h, k, m, n, p, q, u, C, V, kd, ld, md, nd, od, x, pd, qd, rd, sd, W, v, b, H, ud, f, ta, ua, $c(c), cd(d.google_additional_params), cd(d.google_remarketing_only ? {} : d.google_additional_conversion_params),
        ...
        if (!d.google_remarketing_only && !d.google_conversion_domain) {
            ...
            if (d)
                if (t = d.google_conversion_items) {
                    A = [];
                    h = 0;
                    for (k = t.length; h < k; h++) m = t[h], n = [], m && (n.push(U(m.value)), n.push(U(m.quantity)), n.push(U(m.item_id)),
                        n.push(U(m.start_date)), n.push(U(m.end_date)), A.push("(" + n.join("*") + ")"));
                    t = 0 < A.length ? "&item=" + A.join("") : ""
                } else t = "";
            else t = "";
            c = [a, c, t].join("");
    ...
    function yd(a, b) {
        ...
        a: {
            if (!(Rc || "attributionReporting" in I)) {
            ...
            if (!Ad && (Ad = !0, !c.google_gtm)) {
                ...
                if (d) {
                    ...
                    if (!a["google.tagmanager.debugui2.queue"]) {
                        ...
                        var m = va(k instanceof ja && k.constructor === ja && k.g === la ? k.i : "type_error:Const");
                        c = {
                            id: h,
                            src: "LEGACY",
                            cond: d
