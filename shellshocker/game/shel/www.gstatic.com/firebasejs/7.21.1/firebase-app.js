! function(e, t) {
    ...
    var o, s, l, c = "FirebaseError",
        h = (o = Error, r(s = f, l = o), s.prototype = null === l ? Object.create(l) : (p.prototype = l.prototype, new p), f);
    ...
    var P, A = (j.prototype.addComponent = function(e) {
    ...
    var W, G = ((x = {})["no-app"] = "No Firebase App '{$appName}' has been created - call Firebase App.initializeApp()", x["bad-app-name"] = "Illegal App name: '{$appName}", x["duplicate-app"] = "Firebase App named '{$appName}' already exists", x["app-deleted"] = "Firebase App named '{$appName}' already deleted", x["invalid-app-argument"] = "firebase.{$appName}() takes either no argument or a Firebase App instance.", x["invalid-log-argument"] = "First argument to `onLog` must be null or a function.", x),
        ...
        var c = {},
            ...
            p = {
                ...
                registerVersion: function(e, t, r) {
                    var n, i = null !== (n = J[e]) && void 0 !== n ? n : e;
                    r && (i += "-" + r);
                    var o = i.match(/\s|\//),
                        a = t.match(/\s|\//);
                    if (o || a) {
    ...
    return le.registerVersion("firebase", "7.21.1", "app"), le
});
