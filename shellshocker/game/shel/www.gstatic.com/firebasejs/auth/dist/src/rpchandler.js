        ...
        if (self.validateStsTokenRequest_(data)) {
            self.sendXhr_(
                ...
                function(response) {
                    ...
                    } else if (!response[fireauth.RpcHandler.StsServerField.ACCESS_TOKEN] ||
...
fireauth.RpcHandler.prototype.verifyBeforeUpdateEmail =
    function(idToken, newEmail, additionalRequestData) {
        var request = {
            'requestType': fireauth.RpcHandler.GetOobCodeRequestType.VERIFY_AND_CHANGE_EMAIL,
            'idToken': idToken,
            'newEmail': newEmail
        };
        // Extend the original request with the additional data.
...
fireauth.RpcHandler.validateWithdrawMfaResponse_ = function(response) {
    ...
    var hasRefreshToken = !!response[fireauth.RpcHandler.AuthServerField.REFRESH_TOKEN];
...
fireauth.RpcHandler.ApiMethod = {
    ...
    GET_EMAIL_VERIFICATION_CODE_BEFORE_UPDATE: {
        ...
        requestValidator: fireauth.RpcHandler.validateEmailVerificationCodeBeforeUpdateRequest_,
        responseField: fireauth.RpcHandler.AuthServerField.EMAIL,
        requireTenantId: true
    },
    GET_OOB_CODE: {
    ...
    START_PHONE_MFA_ENROLLMENT: {
        ...
        requestValidator: fireauth.RpcHandler.validateStartPhoneMfaEnrollmentRequest_,
        responseValidator: fireauth.RpcHandler.validateStartPhoneMfaEnrollmentResponse_,
        requireTenantId: true,
        useIdentityPlatformEndpoint: true
    },
