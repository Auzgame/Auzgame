...
fireauth.exportlib.exportFunction(
    ...
    fireauth.PhoneMultiFactorGenerator.assertion, [fireauth.args.authCredential(fireauth.idp.ProviderId.PHONE)]);
        ...
        var namespace = {
            ...
            'ActionCodeInfo': {
                'Operation': {
                    ...
                    'REVERT_SECOND_FACTOR_ADDITION': fireauth.ActionCodeInfo.Operation.REVERT_SECOND_FACTOR_ADDITION,
                    'VERIFY_AND_CHANGE_EMAIL': fireauth.ActionCodeInfo.Operation.VERIFY_AND_CHANGE_EMAIL,
        ...
        const authInteropComponent = {
            ...
            'instanceFactory': function(container) {
                ...
                return {
                    ...
                    'removeAuthTokenListener': goog.bind(auth.removeAuthTokenListenerInternal, auth)
                };
            },
            'multipleInstances': false,
            'instantiationMode': 'LAZY',
