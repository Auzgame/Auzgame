...
fireauth.constants.Endpoint = {
    ...
    BOQ: {
        ...
        secureTokenEndpoint: 'https://staging-securetoken.sandbox.googleapis.com' +
            '/v1/token',
        identityPlatformEndpoint: 'https://staging-identitytoolkit.sandbox.googleapis.com/v2/',
        id: 'b'
    },
    PRODUCTION: {
    ...
    TEST: {
        ...
        secureTokenEndpoint: 'https://test-securetoken.sandbox.googleapis.com/v1' +
            '/token',
        identityPlatformEndpoint: 'https://test-identitytoolkit.sandbox.googleapis.com/v2/',
        id: 't'
    }
};
