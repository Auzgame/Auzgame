function createUnityInstance(e, r, t) {
    ...
    return c.SystemInfo = function() {
        ...
        c.SystemInfo.hasWebGL ? 1 == c.SystemInfo.hasWebGL ? r("Your browser does not support graphics API \"WebGL 2.0\" which is required for this content.") : c.SystemInfo.hasWasm ? (1 == c.SystemInfo.hasWebGL && c.print("Warning: Your browser does not support \"WebGL 2.0\" Graphics API, switching to \"WebGL 1.0\""), c.startupErrorHandler = r, t(0), c.postRun.push(function() {
