    ...
    function() {
        var e = function(e) {
            ...
            function n() {
                ...
                }, new t(0, 9431348, 0, 0).open("GET", "/data.unity3d"), new t(9431348, 9431763, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(9431763, 12039219, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(12039219, 13535911, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(13535911, 13563537, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_WebGL.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {
                    fromCache: !1
                }, l ? (n(l), l = null) : d = n
            }
            var o;
