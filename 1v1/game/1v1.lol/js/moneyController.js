  ...
  if (window.innerHeight < 900) {
    if (document.getElementById("adRectangleBottom") == null) {
      ...
      cpmstarAPI({
        kind: "go",
        module: "POOL 83025",
        config: { conditions: { target: { el: el, kind: "replace" } } },
      });
    }
  } else {
...
async function showAds() {
  ...
  document.getElementsByClassName("ad-rectangle-bottom")[0].style.display =
    "block";
  document.getElementsByClassName("ad-leaderboard-bottom")[0].style.display =
    "block";
  document.getElementsByClassName("ad-rectangle-upper")[0].style.display =
    "block";
