...
goog.scope(function () {
  ...
  BaseTestChannel.prototype.connect = function (path) {
    ...
    if (
      !this.channel_.getBackgroundChannelTest() &&
    ...
    this.request_ = ChannelRequest.createChannelRequest(
      this,
      this.channelDebug_
    );
      ...
      if (this.receivedIntermediateResult_) {
        ...
        if (responseText == "11111") {
          requestStats.notifyStatEvent(
            requestStats.Stat.TEST_STAGE_TWO_DATA_ONE
          );
