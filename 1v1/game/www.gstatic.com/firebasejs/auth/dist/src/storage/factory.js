...
fireauth.storage.Factory.getInstance = function () {
  if (!fireauth.storage.Factory.instance_) {
    fireauth.storage.Factory.instance_ = new fireauth.storage.Factory(
      fireauth.storage.Factory.getEnvConfig()
    );
  }
...
fireauth.storage.Factory.getEnvConfig = function () {
  ...
  envMap[fireauth.util.Env.WORKER] = fireauth.storage.Factory.EnvConfig.WORKER;
