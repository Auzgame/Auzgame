 ...
 * @override
 */
fireauth.GRecaptchaMockFactory.prototype.render = function (
  elementOrId,
  params
) {
  this.map_[this.counter_.toString()] = new fireauth.RecaptchaMock(
    elementOrId,
    params
  );
...
fireauth.GRecaptchaMockFactory.prototype.getId_ = function (opt_id) {
  var id =
    typeof opt_id === "undefined"
      ? fireauth.GRecaptchaMockFactory.START_INSTANCE_ID
      : opt_id;
