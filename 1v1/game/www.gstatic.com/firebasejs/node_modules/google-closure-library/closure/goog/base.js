 ...
 * @private @const
 */
goog.loadModuleFromSource_ = /** @type {function(string):?} */ (
  function () {
...
goog.defineClass.isUnsealable_ = function (ctr) {
  return (
    ctr && ctr.prototype && ctr.prototype[goog.UNSEALABLE_CONSTRUCTOR_PROPERTY_]
  );
};
    ...
    if (
      ...
      var nonceAttr =
        !goog.DebugLoader_.IS_OLD_IE_ && goog.getScriptNonce()
          ...
          : "";
      var event = goog.DebugLoader_.IS_OLD_IE_
        ? "onreadystatechange"
        : "onload";
