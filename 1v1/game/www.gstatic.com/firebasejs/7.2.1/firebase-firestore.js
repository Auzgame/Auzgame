    ...
    (function () {
        ...
        if ("" != r.b) e && $e(r, e + "." + r.b), tn(r, r.i);
          ...
          (i = e ? e + "." + o.hostname : o.hostname),
            (r = (function (t, e, n, r) {
              ...
              return (
                t && Ze(i, t), e && $e(i, e), n && tn(i, n), r && (i.a = r), i
              );
      ...
      var ra =
        ...
        (ia.prototype.store = function (t) {
          ...
          return (
            Vr(!!e, "Object store not part of transaction: " + t), new oa(e)
          );
        }),
        ia);
      function ia(t) {
      ...
      var oa =
        ...
        (aa.prototype.get = function (e) {
          ...
          return sa(this.store.get(e)).next(function (t) {
            return (
              void 0 === t && (t = null), Pr(Zo, "GET", n.store.name, e, t), t
            );
          });
        }),
      ...
      function ka(t, e, n) {
        ...
        return (
          (r.key = t), (r.value = e), (r.precondition = n), (r.type = wa.Set), r
        );
      }
      var Ra,
        Ma =
          ...
          (Oa.prototype.patchDocument = function (t) {
            var e;
            return (
              (e = t instanceof xs ? t.data() : As.EMPTY), this.patchObject(e)
            );
          }),
      ...
      var cc =
        ...
        (hc.prototype.start = function () {
          ...
          return (
            ...
            $o
              ...
              .then(function (t) {
                return (
                  (e.simpleDb = t), e.updateClientMetadataAndTryBecomePrimary()
                );
              })
              .then(function () {
                return (
        ...
        (hc.prototype.updateClientMetadataAndTryBecomePrimary = function () {
          ...
          return this.simpleDb.runTransaction("readwrite", qu, function (n) {
            return dc(n)
              .put(
                new _u(r.clientId, Date.now(), r.networkEnabled, r.inForeground)
              )
              .next(function () {
                if (r.isPrimary)
      ...
      var hh =
        ...
        (lh.prototype.lookup = function (e) {
          ...
          return this.invokeStreamingRPC("BatchGetDocuments", t).then(function (
            t
          ) {
            var n = Io();
            t.forEach(function (t) {
      ...
      var Wh =
        ...
        (Gh.prototype.isActiveTarget = function (t) {
          ...
          return (
            e || Pr("WatchChangeAggregator", "Detected inactive target", t), e
          );
        }),
            ...
            return d(this, void 0, void 0, function () {
              return p(this, function (t) {
                switch (t.label) {
                  ...
                  case 1:
                    return (
                      t.sent(), this.onlineStateTracker.set(fh.Offline), [2]
                    );
                }
              });
            });
                      ...
                      n instanceof Qh && n.state === Fh.Removed && n.cause
                        ...
                        : (n instanceof Bh
                            ...
                            : (Vr(
                              ...
                              this.watchChangeAggregator.handleTargetChange(n)),
                          r.isEqual(uo.MIN)
                            ? [3, 3]
                            : [
                                4,
            ...
            return d(this, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                switch (t.label) {
                  ...
                  case 2:
                    return (
                      this.addToWritePipeline(n), [4, this.fillWritePipeline()]
                    );
                  case 3:
                    t.sent(), (t.label = 4);
                  case 4:
      ...
      var Yl =
        ...
        (Xl.prototype.fromFieldTransform = function (t) {
          ...
          if ("setToServerValue" in t)
            ...
            Vr(i instanceof ts, "NUMERIC_ADD transform requires a NumberValue"),
              (n = new ql(i));
            ...
            return d(this, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                switch (t.label) {
                  case 0:
                    return (
                      (e = u.query), [4, this.localStore.executeQuery(e, !0)]
                    );
                  case 1:
                    return (
                      (n = t.sent()),
            ...
            return d(this, void 0, void 0, function () {
              ...
              return p(this, function (t) {
                switch (t.label) {
                  ...
                  case 2:
                    return (
                      t.sent(), [4, this.localStore.allocateQuery(s.query)]
                    );
                  case 3:
                    return (
                      (a = t.sent()),
                  ...
                  case 4:
                    return (
                      (u = t.sent()).snapshot && n.push(u.snapshot), [3, 9]
                    );
                  case 5:
                    return (
                      Vr(
        ...
        Bf =
              ...
              return d(t, void 0, void 0, function () {
                return p(this, function (t) {
                  switch (t.label) {
                    ...
                    case 3:
                      return (
                        t.sent(), this.credentials.removeChangeListener(), [2]
                      );
                  }
                });
              });
          ...
          (Uf.prototype.addSnapshotsInSyncListener = function (t) {
            ...
            this.verifyNotTerminated(),
              this.asyncQueue.enqueueAndForget(function () {
                return (
                  e.eventMgr.addSnapshotsInSyncListener(t), Promise.resolve()
                );
              });
          }),
      ...
      var Xf =
        ...
        (Jf.prototype.removeChangeListener = function () {
          Vr(null != this.tokenListener, "removeChangeListener() called twice"),
            Vr(
              null !== this.changeListener,
        ...
        Od =
          ...
          (_d.prototype.parseData = function (t, e) {
            if (Ld((t = this.runPreConverter(t, e))))
              return (
                Pd("Unsupported field value:", e, t), this.parseObject(t, e)
              );
            if (t instanceof rd)
      ...
      var Qd =
        ...
        (Kd.prototype.enableNetwork = function () {
          return (
            this.ensureClientConfigured(), this._firestoreClient.enableNetwork()
          );
        }),
